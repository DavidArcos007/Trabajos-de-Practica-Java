...
public class Casilla extends JLabel {
    ...
    /**
     * Cuando una imagen es congelada, no se puede volver a ocultar hasta
    ...
    /**
     * Metodo que retorna el valor boolean de una casilla si este esta o no
     * congelado
     *
     * @return boolean
     */
    ...
    public void setBandera(String name) {
        this.sBandera = name;
        if (!name.equals("")) {
            bandera = new ImageIcon(getClass().getResource("/com/bolivia/ram/res/" + name + ".jpg"));
        }
    }

    /**
     * Retorna el nombre de la bandera que tenga asignada la casilla, si no
     * tiene ninguna retorna una cadena vacia
     *
     * @return String
     */
